...
```
	new:                tensorboard
	new:                tensorboard/train/events.out.tfevents.1584285846.f17c4a64818c.263.373.v2
	new:                tensorboard/train/events.out.tfevents.1584285848.f17c4a64818c.profile-empty
	new:                tensorboard/train/plugins/profile/2020_03_15_15_24_08/f17c4a64818c.input_pipeline.pb
	new:                tensorboard/train/plugins/profile/2020_03_15_15_24_08/f17c4a64818c.overview_page.pb
	new:                tensorboard/train/plugins/profile/2020_03_15_15_24_08/f17c4a64818c.tensorflow_stats.pb
	new:                tensorboard/train/plugins/profile/2020_03_15_15_24_08/f17c4a64818c.trace.json.gz
	new:                tensorboard/validation/events.out.tfevents.1584285861.f17c4a64818c.263.2285.v2
	new:                tf_model.h5
...
```
python source/train.py --learning-rate 0.0001 --batch-size 66 --num-of-epochs 3 --activation-function relu --kernel-width 3 --average-kernels 32 --num-of-conv-layers 5 --kernel-increasing-factor 1.2 --maxpool-after-n-layer 0 --dropout-factor-after-conv 0.1 --dropout-factor-after-maxp 0.25
