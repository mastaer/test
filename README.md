...
```
	new:                tensorboard
	new:                tensorboard/train/events.out.tfevents.1584259650.cdfee0f0a80c.264.373.v2
	new:                tensorboard/train/events.out.tfevents.1584259652.cdfee0f0a80c.profile-empty
	new:                tensorboard/train/plugins/profile/2020_03_15_08_07_32/cdfee0f0a80c.input_pipeline.pb
	new:                tensorboard/train/plugins/profile/2020_03_15_08_07_32/cdfee0f0a80c.overview_page.pb
	new:                tensorboard/train/plugins/profile/2020_03_15_08_07_32/cdfee0f0a80c.tensorflow_stats.pb
	new:                tensorboard/train/plugins/profile/2020_03_15_08_07_32/cdfee0f0a80c.trace.json.gz
	new:                tensorboard/validation/events.out.tfevents.1584259668.cdfee0f0a80c.264.2285.v2
	new:                tf_model.h5
...
```
python source/train.py --learning-rate 0.0001 --batch-size 87 --num-of-epochs 3 --activation-function relu --kernel-width 3 --average-kernels 32 --num-of-conv-layers 5 --kernel-increasing-factor 1.2 --maxpool-after-n-layer 0 --dropout-factor-after-conv 0.1 --dropout-factor-after-maxp 0.25
