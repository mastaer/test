...
```
	new:                tensorboard
	new:                tensorboard/train/events.out.tfevents.1584081201.856e4c28d619.209.407.v2
	new:                tensorboard/train/events.out.tfevents.1584081202.856e4c28d619.profile-empty
	new:                tensorboard/train/plugins/profile/2020-03-13_06-33-22/local.trace
	new:                tensorboard/validation/events.out.tfevents.1584081226.856e4c28d619.209.1957.v2
	new:                tf_model.h5
...
python source/train.py --learning-rate 0.1 --batch-size 128 --num-of-epochs 1 --activation-function relu --kernel-width 3 --average-kernels 8 --num-of-conv-layers 2 --kernel-increasing-factor 1 --maxpool-after-n-layer 1 --dropout-factor-after-conv 0 --dropout-factor-after-maxp 0
