...
```
	new:                tensorboard
	new:                tensorboard/train/events.out.tfevents.1584259537.5b7173f151fe.263.373.v2
	new:                tensorboard/train/events.out.tfevents.1584259539.5b7173f151fe.profile-empty
	new:                tensorboard/train/plugins/profile/2020_03_15_08_05_39/5b7173f151fe.input_pipeline.pb
	new:                tensorboard/train/plugins/profile/2020_03_15_08_05_39/5b7173f151fe.overview_page.pb
	new:                tensorboard/train/plugins/profile/2020_03_15_08_05_39/5b7173f151fe.tensorflow_stats.pb
	new:                tensorboard/train/plugins/profile/2020_03_15_08_05_39/5b7173f151fe.trace.json.gz
	new:                tensorboard/validation/events.out.tfevents.1584259555.5b7173f151fe.263.2285.v2
	new:                tf_model.h5
...
```
python source/train.py --learning-rate 0.0001 --batch-size 85 --num-of-epochs 3 --activation-function relu --kernel-width 3 --average-kernels 32 --num-of-conv-layers 5 --kernel-increasing-factor 1.2 --maxpool-after-n-layer 0 --dropout-factor-after-conv 0.1 --dropout-factor-after-maxp 0.25
