...
```
	new:                tensorboard
	new:                tensorboard/train/events.out.tfevents.1584259104.b382233c149f.263.373.v2
	new:                tensorboard/train/events.out.tfevents.1584259107.b382233c149f.profile-empty
	new:                tensorboard/train/plugins/profile/2020_03_15_07_58_27/b382233c149f.input_pipeline.pb
	new:                tensorboard/train/plugins/profile/2020_03_15_07_58_27/b382233c149f.overview_page.pb
	new:                tensorboard/train/plugins/profile/2020_03_15_07_58_27/b382233c149f.tensorflow_stats.pb
	new:                tensorboard/train/plugins/profile/2020_03_15_07_58_27/b382233c149f.trace.json.gz
	new:                tensorboard/validation/events.out.tfevents.1584259119.b382233c149f.263.2285.v2
	new:                tf_model.h5
...
```
python source/train.py --learning-rate 0.0001 --batch-size 67 --num-of-epochs 3 --activation-function relu --kernel-width 3 --average-kernels 32 --num-of-conv-layers 5 --kernel-increasing-factor 1.2 --maxpool-after-n-layer 0 --dropout-factor-after-conv 0.1 --dropout-factor-after-maxp 0.25
