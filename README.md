...
```
	new:                tensorboard
	new:                tensorboard/train/events.out.tfevents.1584259114.6dca74d0e50e.264.373.v2
	new:                tensorboard/train/events.out.tfevents.1584259117.6dca74d0e50e.profile-empty
	new:                tensorboard/train/plugins/profile/2020_03_15_07_58_37/6dca74d0e50e.input_pipeline.pb
	new:                tensorboard/train/plugins/profile/2020_03_15_07_58_37/6dca74d0e50e.overview_page.pb
	new:                tensorboard/train/plugins/profile/2020_03_15_07_58_37/6dca74d0e50e.tensorflow_stats.pb
	new:                tensorboard/train/plugins/profile/2020_03_15_07_58_37/6dca74d0e50e.trace.json.gz
	new:                tensorboard/validation/events.out.tfevents.1584259136.6dca74d0e50e.264.2285.v2
	new:                tf_model.h5
...
```
python source/train.py --learning-rate 0.0001 --batch-size 110 --num-of-epochs 3 --activation-function relu --kernel-width 3 --average-kernels 32 --num-of-conv-layers 5 --kernel-increasing-factor 1.2 --maxpool-after-n-layer 0 --dropout-factor-after-conv 0.1 --dropout-factor-after-maxp 0.25
