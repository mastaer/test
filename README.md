...
```
	new:                tensorboard
	new:                tensorboard/train/events.out.tfevents.1584259195.5fb424a57af9.263.373.v2
	new:                tensorboard/train/events.out.tfevents.1584259197.5fb424a57af9.profile-empty
	new:                tensorboard/train/plugins/profile/2020_03_15_07_59_57/5fb424a57af9.input_pipeline.pb
	new:                tensorboard/train/plugins/profile/2020_03_15_07_59_57/5fb424a57af9.overview_page.pb
	new:                tensorboard/train/plugins/profile/2020_03_15_07_59_57/5fb424a57af9.tensorflow_stats.pb
	new:                tensorboard/train/plugins/profile/2020_03_15_07_59_57/5fb424a57af9.trace.json.gz
	new:                tensorboard/validation/events.out.tfevents.1584259218.5fb424a57af9.263.2285.v2
	new:                tf_model.h5
...
```
python source/train.py --learning-rate 0.0001 --batch-size 119 --num-of-epochs 3 --activation-function relu --kernel-width 3 --average-kernels 32 --num-of-conv-layers 5 --kernel-increasing-factor 1.2 --maxpool-after-n-layer 0 --dropout-factor-after-conv 0.1 --dropout-factor-after-maxp 0.25
