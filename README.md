...
```
	new:                tensorboard
	new:                tensorboard/train/events.out.tfevents.1584258497.afbc2aa9013d.263.373.v2
	new:                tensorboard/train/events.out.tfevents.1584258500.afbc2aa9013d.profile-empty
	new:                tensorboard/train/plugins/profile/2020_03_15_07_48_20/afbc2aa9013d.input_pipeline.pb
	new:                tensorboard/train/plugins/profile/2020_03_15_07_48_20/afbc2aa9013d.overview_page.pb
	new:                tensorboard/train/plugins/profile/2020_03_15_07_48_20/afbc2aa9013d.tensorflow_stats.pb
	new:                tensorboard/train/plugins/profile/2020_03_15_07_48_20/afbc2aa9013d.trace.json.gz
	new:                tensorboard/validation/events.out.tfevents.1584258522.afbc2aa9013d.263.2285.v2
	new:                tf_model.h5
...
```
python source/train.py --learning-rate 0.0001 --batch-size 127 --num-of-epochs 3 --activation-function relu --kernel-width 3 --average-kernels 32 --num-of-conv-layers 5 --kernel-increasing-factor 1.2 --maxpool-after-n-layer 0 --dropout-factor-after-conv 0.1 --dropout-factor-after-maxp 0.25
