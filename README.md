...
```
	new:                tensorboard
	new:                tensorboard/train/events.out.tfevents.1584259009.5aa735fe76ba.263.373.v2
	new:                tensorboard/train/events.out.tfevents.1584259012.5aa735fe76ba.profile-empty
	new:                tensorboard/train/plugins/profile/2020_03_15_07_56_52/5aa735fe76ba.input_pipeline.pb
	new:                tensorboard/train/plugins/profile/2020_03_15_07_56_52/5aa735fe76ba.overview_page.pb
	new:                tensorboard/train/plugins/profile/2020_03_15_07_56_52/5aa735fe76ba.tensorflow_stats.pb
	new:                tensorboard/train/plugins/profile/2020_03_15_07_56_52/5aa735fe76ba.trace.json.gz
	new:                tensorboard/validation/events.out.tfevents.1584259022.5aa735fe76ba.263.2285.v2
	new:                tf_model.h5
...
```
python source/train.py --learning-rate 0.0001 --batch-size 54 --num-of-epochs 3 --activation-function relu --kernel-width 3 --average-kernels 32 --num-of-conv-layers 5 --kernel-increasing-factor 1.2 --maxpool-after-n-layer 0 --dropout-factor-after-conv 0.1 --dropout-factor-after-maxp 0.25
