...
```
	new:                tensorboard
	new:                tensorboard/train/events.out.tfevents.1584258791.cef841529d9d.267.373.v2
	new:                tensorboard/train/events.out.tfevents.1584258793.cef841529d9d.profile-empty
	new:                tensorboard/train/plugins/profile/2020_03_15_07_53_13/cef841529d9d.input_pipeline.pb
	new:                tensorboard/train/plugins/profile/2020_03_15_07_53_13/cef841529d9d.overview_page.pb
	new:                tensorboard/train/plugins/profile/2020_03_15_07_53_13/cef841529d9d.tensorflow_stats.pb
	new:                tensorboard/train/plugins/profile/2020_03_15_07_53_13/cef841529d9d.trace.json.gz
	new:                tensorboard/validation/events.out.tfevents.1584258804.cef841529d9d.267.2285.v2
	new:                tf_model.h5
...
```
python source/train.py --learning-rate 0.0001 --batch-size 58 --num-of-epochs 3 --activation-function relu --kernel-width 3 --average-kernels 32 --num-of-conv-layers 5 --kernel-increasing-factor 1.2 --maxpool-after-n-layer 0 --dropout-factor-after-conv 0.1 --dropout-factor-after-maxp 0.25
