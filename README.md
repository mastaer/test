...
```
	new:                tensorboard
	new:                tensorboard/train/events.out.tfevents.1584258841.241886f415e1.263.373.v2
	new:                tensorboard/train/events.out.tfevents.1584258843.241886f415e1.profile-empty
	new:                tensorboard/train/plugins/profile/2020_03_15_07_54_03/241886f415e1.input_pipeline.pb
	new:                tensorboard/train/plugins/profile/2020_03_15_07_54_03/241886f415e1.overview_page.pb
	new:                tensorboard/train/plugins/profile/2020_03_15_07_54_03/241886f415e1.tensorflow_stats.pb
	new:                tensorboard/train/plugins/profile/2020_03_15_07_54_03/241886f415e1.trace.json.gz
	new:                tensorboard/validation/events.out.tfevents.1584258856.241886f415e1.263.2285.v2
	new:                tf_model.h5
...
```
python source/train.py --learning-rate 0.0001 --batch-size 68 --num-of-epochs 3 --activation-function relu --kernel-width 3 --average-kernels 32 --num-of-conv-layers 5 --kernel-increasing-factor 1.2 --maxpool-after-n-layer 0 --dropout-factor-after-conv 0.1 --dropout-factor-after-maxp 0.25
